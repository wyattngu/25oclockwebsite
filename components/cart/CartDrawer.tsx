...
export function CartDrawer() {
  ...
  return (
    <Drawer isOpen={isOpen} onClose={closeCart} side="right" title={`Giỏ hàng (${lines.length})`}>
      {lines.length === 0 ? (
        <div className="flex h-full flex-col items-center justify-center gap-4 p-8 text-center">
          <p className="text-[14px] text-ink-60">Giỏ hàng của bạn đang trống.</p>
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-5">
            ...
            <div className="py-4">
              <label className="mb-2 block text-[12px] uppercase tracking-wider text-ink-60">Ghi chú đơn hàng</label>
